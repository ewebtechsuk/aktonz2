...
const SCRAYE_LANDLORD_CONTACT_ID =
  process.env.APEX27_SCRAYE_LANDLORD_ID || 'apx-contact-scraye';
...
function mapListingToPayload(listing) {
  ...
  return {
    ...
    landlordContactId: listing.landlordContactId || SCRAYE_LANDLORD_CONTACT_ID,
