import contactsSource from '../data/apex27-contacts.json';
import agentsSource from '../data/agents.json';
...
const NOTES_KEYS = Object.freeze([
  'notes',
  'Notes',
  'note',
  'latestNote',
...
function buildContactLinks(contact) {
  ...
  return {
    ...
    callReminder: `${basePath}/tasks/new?type=call`,
    delegatedTask: `${basePath}/tasks/new?delegated=1`,
    logCommunication: `${basePath}/communications/new`,
    assignAgent: `${basePath}/assign-agent`,
    emailPropertyDetails: `${basePath}/emails/property-details`,
    bookViewing: `${basePath}/viewings/new`,
...
function normaliseContact(entry) {
  ...
  const contact = {
    ...
    generatedNotes: sanitizeString(readFirstString(entry, NOTES_KEYS) || entry.notes || '') || null,
    daysInPipeline,
  };
