...
export async function loadScrayeListingsByType(type) {
  ...
  if (scrayeListingsCache.has(cacheKey)) {
    return scrayeListingsCache.get(cacheKey);
  }

  if (scrayeListingsPromiseCache.has(cacheKey)) {
    return scrayeListingsPromiseCache.get(cacheKey);
  }
  ...
  try {
    ...
    scrayeListingsCache.set(cacheKey, normalizedResult);
