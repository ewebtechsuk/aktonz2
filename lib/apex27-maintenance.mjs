...
const fallbackMaintenanceSource = loadJson('data/apex27-maintenance.json', {
  tasks: [],
});

const FALLBACK_TASKS = Array.isArray(fallbackMaintenanceSource?.tasks)
  ? fallbackMaintenanceSource.tasks
  : [];

const require = createRequire(import.meta.url);
const maintenanceSource = require('../data/apex27-maintenance.json');
