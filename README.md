...
The Microsoft OAuth flow is implemented in `pages/api/microsoft/connect.cjs`,
`pages/api/microsoft/callback.cjs`, and the legacy/local-compatible route
`pages/api/admin/email/microsoft/callback.cjs` (kept for older admin dashboards).
